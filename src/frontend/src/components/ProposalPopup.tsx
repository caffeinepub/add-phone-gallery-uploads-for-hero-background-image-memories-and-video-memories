    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
        <div className="bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 rounded-3xl shadow-2xl max-w-lg w-full border-4 border-rose-200/50 animate-in zoom-in duration-500">
          ...
          <div className="p-8 text-center space-y-8">
            {/* Animated Ring with rotating emojis */}
      ...
      {showSurprise && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-300">
          <div className="bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 rounded-3xl shadow-2xl max-w-md w-full border-4 border-rose-200/50 animate-in zoom-in duration-500">
            <div className="p-8 text-center space-y-6">
              ...
              <p className="text-lg text-rose-800 leading-relaxed">
                I promise to love you unconditionally,<br />
                cherish every moment with you,<br />
                and make you smile every single day.<br />
                You are my forever! 🧿 🎀 👑
              </p>
              <button
