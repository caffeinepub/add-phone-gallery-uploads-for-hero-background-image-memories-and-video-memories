...
export const idlService = IDL.Service({
  ...
  'getImageUploaderAllowlist' : IDL.Func(
      [],
  ...
  'grantImageUploaderAccess' : IDL.Func([IDL.Principal], [], []),
  'hasImageUploaderAccess' : IDL.Func([IDL.Principal], [IDL.Bool], ['query']),
  'isCallerAdmin' : IDL.Func([], [IDL.Bool], ['query']),
  'prePublishCheck' : IDL.Func([PrePublishConfig], [PrePublishResult], []),
  'recordDeployment' : IDL.Func([IDL.Text, DeploymentStatus], [], []),
  'revokeImageUploaderAccess' : IDL.Func([IDL.Principal], [], []),
